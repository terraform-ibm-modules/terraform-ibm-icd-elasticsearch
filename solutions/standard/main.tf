...
locals {
  ...
  code_engine_project_name = local.code_engine_project_id != null ? null : (var.prefix != null && var.prefix != "") ? "${var.prefix}-code-${local.default_code_engine_project_name}" : "${local.default_code_engine_project_name}"
