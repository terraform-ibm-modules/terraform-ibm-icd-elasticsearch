...
func TestRunStandardSolutionSchematics(t *testing.T) {
	...
	options.TerraformVars = []testschematic.TestSchematicTerraformVar{
		...
		{Name: "existing_code_engine_project_name", Value: options.Prefix, DataType: "string"},
	}
...
func TestRunBasicExample(t *testing.T) {
	...
	options := testhelper.TestOptionsDefaultWithVars(&testhelper.TestOptions{
		...
		Prefix:           "es-test",
		ResourceGroup:    resourceGroup,
		Region:           "us-south", // Region hardcoded due to this issue https://github.com/terraform-ibm-modules/terraform-ibm-icd-elasticsearch/issues/317
		CloudInfoService: sharedInfoSvc,
