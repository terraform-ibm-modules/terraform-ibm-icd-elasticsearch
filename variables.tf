...
variable "use_default_backup_encryption_key" {
  type        = bool
  description = "Whether to use the IBM Cloud Databases generated keys for backup encryption."
  default     = false
}
...
variable "enable_elser_model" {
  type        = bool
  description = "Set it to true to install and start the Elastic's Natural Language Processing model. Applies only if 'plan' is set to 'platinum'. [Learn more](https://cloud.ibm.com/docs/databases-for-elasticsearch?topic=databases-for-elasticsearch-elser-embeddings-elasticsearch)"
  default     = false
}
