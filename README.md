...
| <a name="input_resource_tags"></a> [resource\_tags](#input\_resource\_tags) | The list of tags to be added to the Databases for Elasticsearch instance. | `list(string)` | `[]` | no |
