...
variable "kms_key_crn" {
  type        = string
  description = "The root key CRN of a Key Protect instance that you want to use for disk encryption. See https://cloud.ibm.com/docs/cloud-databases?topic=cloud-databases-key-protect&interface=ui for more information on integrating Key Protect with Elasticsearch instance."
}
...
variable "backup_encryption_key_crn" {
  type        = string
  description = "The CRN of a Key Protect key to use for encrypting the disk that holds deployment backups. There are limitation per region for backup encryption. See https://cloud.ibm.com/docs/cloud-databases?topic=cloud-databases-key-protect&interface=ui#key-byok"
  default     = null
