...
response=$(curl -s -w "%{http_code}" -kX POST "$ES/_ml/trained_models/.elser_model_2_linux-x86_64/deployment/_start?wait_for=started&timeout=3m&deployment_id=for_search&pretty")
